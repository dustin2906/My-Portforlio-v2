...
import L_MAYVARY from "../../assets/img/projects/Mayvary.png";
...
import L_WORDPRESS from "../../assets/img/skills/wordpress-icon.png";
...
const ProjectTimeline = () => {
  return (
    <div id="project">
      <h1 className="pt-3 text-center font-details-b pb-3">PUBLIC PROJECTS</h1>
      <Timeline>
        <Events>
                ...
                <Accordion>
                  <Card>
                    ...
                    <Accordion.Collapse eventKey="0" className="text-left">
                      <Card.Body>
                        <strong>Description:</strong> This is a Review Movie App
                        created with React and ReactRouter that review popular
                        movies for internet users.
                        <hr />
                        <strong>Features:</strong>
                        <ul className="list-styles pt-1">
                          <li>Review and Search Popular Movies </li>
                          <li>
                            Powered by React, ReactRouter and the Movie DB
                          </li>
              ...
              <div>
                <Accordion>
                  <Card>
                    ...
                    <Accordion.Collapse eventKey="0" className="text-left">
                      <Card.Body>
                        <strong>Description:</strong> This is my Portfolio v1
                        created with HTML5, CSS3, JavaScript, and Bootstrap to
                        show a description about me, my projects in MAYVARY.
                        <hr />
                        <strong>Features:</strong>
                        <ul className="list-styles pt-1">
                          <li>
                            Introduce about my-self, my experiences, my
                            projects.{" "}
                          </li>
                  ...
                  <Card>
                    ...
                    <Accordion.Collapse eventKey="0" className="text-left">
                      <Card.Body>
                        ...
                        created with JavaScript,NodeJS and and deployed on
                        Heroku (data was saved in MongoDB atlas) that keeps a
                        track of your Todos.
                        <hr />
                        <strong>Features:</strong>
                        <ul className="list-styles pt-1">
          ...
          {/** Project: MAYVARY WEBSITE*/}
          <ImageEvent
            date="3/12/2020"
            className="text-center"
            text="MAYVARY Website"
            src={L_MAYVARY}
            alt="Mayvary"
          >
            <div className="d-flex justify-content-between flex-column mt-1">
              <div>
                <Accordion>
                  <Card>
                    ...
                    <Accordion.Collapse eventKey="0" className="text-left">
                      <Card.Body>
                        <strong>Description:</strong> MAYVARY is a media company
                        founded in May 2019. I created this website for MAYVARY
                        during the time I worked in Berlin, Germany.
                        <hr />
                        <strong>Features:</strong>
                        <ul className="list-styles pt-1">
                          <li>MAYVARY Company</li>
